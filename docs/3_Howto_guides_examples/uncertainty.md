...
Finally, it may be the case that while the status of some populations is known, there's a significant possibility for other populations to exist beyond those which are well-documented or known. For instance, the full extent of a species' range may not yet be understood, or there may be suitable habitat in areas which haven't yet been surveyed. In these scenarios, it is recommended that the PM indicator be calculated based on the partial knowledge of the extinct/extant populations, and that the uncertainty regarding the number of populations be noted within the assessment. [KOBO forms](https://ccgenetics.github.io/guidelines-genetic-diversity-indicators/docs/5_Data_collection/Web_tool.html) used to collect data for indicator calculations may include questions gauging the certainty surrounding the number of extinct/extant populations.
